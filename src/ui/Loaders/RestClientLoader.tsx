...
const RestClientLoader = (): ReactElement => {
  return (
    <div data-testid="RestLoader" className="flex flex-col items-center p-10 gap-10 mt-[24px]">
      <div className="flex flex-col items-center gap-5 w-full sm:w-[70%]">
        <div className="flex justify-between w-full gap-2">
          <section className="rounded-lg w-[160px] text-center">
            <div className="loader h-14 rounded-lg"></div>
          </section>
          <section className="rounded-lg w-full text-center">
            <div className="loader h-14 rounded-lg"></div>
          </section>
          <section className="rounded-lg w-[140px]">
            <div className="loader h-14 rounded-lg"></div>
          </section>
        </div>
        ...
        <div className="flex flex-row gap-3 w-full mt-[10px]">
          <section className="rounded-lg w-full text-center">
            <div className="loader h-14 rounded-lg"></div>
          </section>
          <section className="rounded-lg w-full text-center">
...
export default RestClientLoader;
